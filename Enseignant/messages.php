...
?>
    ...
    <?php
                ...
                $req2 = mysqli_query($conn, "SELECT demande.autoriser,demande.id_sous,demande.id_etud,nom,prenom,titre_sous,matricule,demande.description FROM demande ,soumission,etudiant where soumission.id_sous=demande.id_sous and etudiant.id_etud = demande.id_etud   ;");
          ...
          <div class="row">
              <div class="col-md-18 stretch-card grid-margin">
                <div class="card bg-gradient card-img-holder text-black">
                  <div class="card-body div-hover" style="display: flex;justify-content: left;padding: 15px;">
