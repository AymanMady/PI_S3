...
<div style="overflow-x:auto;"  >
    ...
    <div class="row">
          ...
          <?php 
              ...
              $req_ens_mail =  "SELECT matiere.*,semestre.* FROM matiere,enseigner,enseignant,semestre WHERE enseignant.id_ens=enseigner.id_ens and matiere.id_semestre=semestre.id_semestre and matiere.id_matiere=enseigner.id_matiere  and enseignant.email ='$email' and semestre.id_semestre=$id_semester";
              $i = 0;
